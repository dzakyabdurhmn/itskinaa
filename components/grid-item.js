...
export const Post = ({
  ...
  <Box className="  font-extrabold rounded-xl px-2 py-2 border-2" w="100%">
    <LinkBox
      as={NextLink}
      href={`/${category}/${id}`}
      scroll={false}
    ...
    >
      {/* <div className="p-2">
        <div
          disabled
          className="py-[3px] mb-1  px-[13px] shadow-md no-underline rounded-full bg-blue text-white bg-red-400 font-sans font-semibold text-sm border-blue btn-primary hover:text-white hover:bg-blue-light focus:outline-none active:shadow-none mr-2"
        >
          wssw
        </div>
